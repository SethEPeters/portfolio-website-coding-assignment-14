  ...
  return (
    <div>
      ...
      <Card
        ...
        description="Here is my account that show some of my other projects that I have done in class. This is a resource for if you want to see some of my WIP and smaller projects"
      ></Card>
